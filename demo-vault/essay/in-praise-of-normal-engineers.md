...
"Belongs to":
  - "[[responsibility/publish-essays|Publish Essays →]]"
  - "[[person/charity-majors|Charity Majors]]"
Status: Evergreened
URL: "https://refactoring.fm/p/in-praise-of-normal-engineers"
"👓 Status": Not started
"Created time": "2024-12-02T13:58:00.000Z"
Date: 2025-02-12
"Has Notes":
  - "[[evergreen/how-to-turn-normal-engineers-into-10x-teams|How to turn normal engineers into 10x teams]]"
  - "[[evergreen/hire-the-right-people-not-the-best-ones|Hire the right people, not the best ones]]"
  - "[[evergreen/build-teams-with-normal-people-in-mind|Build teams with normal people in mind]]"
  - "[[evergreen/the-best-teams-are-were-normal-folks-can-do-great-work|The best teams are were normal folks can do great work]]"
  - "[[evergreen/teams-own-software-not-individuals|Teams own software — not individuals]]"
Tags:
  - Author
"🎙️ Status": Not started
Progress: 0
"Is A":
  - Newsletter Edition
notion_id: 150bdf02-815c-8090-b2e5-cb8431040a32
---

# In Praise of “Normal” Engineers 🔨

Hey, Luca here! This is a new article from our brand new [guest author program](https://refactoring.fm/p/introducing-guest-authors), where some of the best engineering writers in the world contribute to Refactoring with original pieces!

Today’s article is from [Charity Majors](https://www.linkedin.com/in/charity-majors/), CTO of Honeycomb, and one of my favorite authors! Also check out [her blog](https://charity.wtf/) and [her books](https://www.amazon.com/stores/Charity-Majors/author/B0786LBVCG?ref=ap_rdr&isDramIntegrated=true&shoppingPortalEnabled=true).

With Charity we are going through what it means to create a 10x engineering teams, and why this is a better mindset than focusing on 10x engineers.

Here is the agenda:

1. **📈 The problem with 10x engineers **— why this concept is slippery and problematic.

1. 🧘‍♂️ **In praise of 1x engineers **— the best engineering orgs are the ones where *normal engineers* can do great work.

1. 🎽 **Turning normal engineers into 10x teams** — how to create top-performing teams that *mint* 10x engineers like nobody's business.

1. 🏆 **Hiring the right people instead of the best** — how to focus on our individual strengths, instead of our lack of weaknesses.

Let’s dive in!

---

![image](../assets/196bdf02815c8083.png)
...
1. 📈 **Measuring productivity is fraught and imperfect**

1. 🎽 **Engineers don’t own software — teams own software**
...
Consider, for a moment, the sheer combinatorial magnitude of skills and experiences at play:
...
**“10x engineer” makes it sound like 10x productivity is an immutable characteristic of a person.** But someone who is a 10x engineer in a particular skill set is still going to have infinitely more areas where they are normal or average (or less).

I know a lot of world class engineers, but I’ve never met anyone who is 10x better than everyone else across the board, in every situation.

### 🎽 Engineers don’t own software — teams own software

Second, and even more importantly: *so what?* It doesn’t matter.
...
### 🙋‍♀️ Let’s talk about “normal” for a moment

A lot of technical people got really attached to our identities as smart kids. 

The software industry tends to reflect and reinforce this preoccupation at every turn, from Netflix’s “[we look for the top 10% of global talent](https://refactoring.fm/p/no-rules-rules)” to Amazon’s talk about “bar-raising” or Coinbase’s recent claim to “hire the top .1%”. (Seriously, guys? Ok, well, Honeycomb is going to hire only the top *.00001%*!)
...
Software engineering both selects for and develops certain types of intelligence, particularly around abstract reasoning, but *nobody* is born a great software engineer.

**Great engineers are made, not born**.

I just don’t think there’s a lot more we can get out of thinking of ourselves as a special class of people, compared to the value we can derive from thinking of ourselves collectively as relatively normal people who have practiced a fairly niche craft for a very long time.
...
None of this should be terribly surprising; it’s all well known wisdom.
...
![image](../assets/1b3bdf02815c80a2.webp)
...
So, a great engineering org is one where you don’t HAVE to be one of the best engineers in the world to have a lot of impact. But — rather ironically — great engineering orgs mint world class engineers like nobody’s business.
...
But companies categorically over-index on finding these people after they’ve already been minted, which ends up reinforcing and replicating all the prejudices and inequities of the world at large. Talent may be evenly distributed across populations, but opportunity is not.
...
I feel like a whole slew of issues (candidates self-selecting out of the interview process, diversity of applicants, etc) would be improved simply by shifting the focus on engineering hiring away from this inordinate emphasis on hiring the BEST PEOPLE, and realigning around the more reasonable and accurate RIGHT PEOPLE.

It’s a competitive advantage to build an environment where people can be hired for their unique strengths, not their lack of weaknesses; where the emphasis is on composing teams rather than hiring the BEST individuals; where inclusivity is a given both for ethical reasons and because it raises the bar for performance for everyone

Inclusive culture is what actual meritocracy depends on.
